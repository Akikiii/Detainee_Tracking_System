            ...
            <div>
                ...
                <div class="grid gap-5">
                    ...
                    <div class="flex flex-row justify-end gap-2.5 mt-[2.12rem]">
                        <a href="{{url('detainee-list')}}" class="buttonFormat border-2 border-black bg-rgba(165, 42, 42, 0) hover:bg-black text-black hover:text-white font-bold py-4 px-4">BACK TO EVENT TIMELINE</a>
                    </div>
