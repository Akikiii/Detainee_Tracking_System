        ...
        <div class="col-start-2 my-[2.36rem] mx-[3rem] col-span-4 bg-[#FFFFFF] py-[2.81rem] px-[2.84rem] border-2 border-black mt-[2.38rem]" style="background-image: url('logos/background-with-grid-bw.png'); background-size: contain;">
            <div>
                ...
                <div class="grid">
                                    ...
                                    <div class="ml-2">
                                        @if(isset($event))
                                            ...
                                            @if ($event->event_type == 'Bail')
                                                <p class="text-left mb-3"><strong>Event Type:</strong> Bail Hearing</p>
                                            ...
                                            @elseif ($event->event_type == 'Plea')
                                                <p class="text-left mb-3"><strong>Event Type:</strong> Plea Bargaining</p>
                                            @else
                                                <p class="text-left mb-3"><strong>Event Type:</strong> {{ $event->event_type }}</p>
                                            @endif
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="flex space-x-4">
                            <div class="flex flex-row py-4 px-4 w-full leading-tight focus:outline-none focus:border-black relative">
                                <!-- Comment Box Section -->
                                <div class="mt-6">
