<x-app-layout>
    ...
    <div class="grid grid-cols-5 bg-[#f0f2f5] grid-row-4">
        ...
        <div class="col-start-2 my-[2.36rem] mx-[3rem] col-span-4 bg-[#FFFFFF] py-[2.81rem] px-[2.84rem] border-black rounded-md mt-[2.38rem]">
            <div>
                <h1 class="text-[1.875rem] uppercase font-bold">View Own Profile</h1>
                ...
                <div class="grid gap-5">
                    ...
                    <div class="flex flex-row justify-end gap-2.5 mt-[2.12rem]">
                        <a href="{{ route('profile.edit') }}" class="buttonFormat bg-[#D0B638] hover:bg-yellow-400 font-bold py-3 px-6 rounded">EDIT PROFILE</a>
                        <a href="{{url('detainee-list')}}" class="buttonFormat bg-red-500 hover:bg-red-600 font-bold py-3 px-4 rounded">BACK</a>
                    </div>
