                        ...
                        @foreach ($data as $team)
                            <div class="flex space-x-4">
                                    ...
                                    <div class="flex justify-between items-center">
                                        <div>
                                            ...
                                            <p class="text-left mb-3"><strong>Status:</strong>
                                                ...
                                                @elseif ($team->statuss === 'inactive')
                                                    <span class="bg-red-500 text-white px-1 py-1 rounded">Pending</span>
                                                @else
                                ...
                                <div class="flex flex-col justify-center items-center">
                                    <a class="bg-gray-400 hover:bg-gray-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline flex-shrink" type="button">
