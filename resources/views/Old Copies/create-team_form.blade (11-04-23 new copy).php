<x-app-layout>
    ...
    <div class="grid grid-cols-5 bg-[#f0f2f5] grid-row-4">
            ...
            <div class="grid gap-4 text-[1.125rem] row-start-1">
                ...
                <div>
                    ...
                    <div class="sections ml-1">
                        ...
                        <a href="{{ url('view-teams') }}" class="flex items-center gap-[0.5rem] mt-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="38" viewBox="0 0 51 49" fill="none">
                                <path d="M35.8017 4.02783V8.05561M25.2743 4.02783V8.05561M14.747 4.02783V8.05561" stroke="#141B34" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M7.37787 20.139C7.37787 13.4935 7.37787 10.1707 9.53624 8.10625C11.6946 6.04175 15.1685 6.04175 22.1161 6.04175H28.4325C35.3801 6.04175 38.854 6.04175 41.0125 8.10625C43.1708 10.1707 43.1708 13.4935 43.1708 20.139V30.2084C43.1708 36.8539 43.1708 40.1766 41.0125 42.2412C38.854 44.3057 35.3801 44.3057 28.4325 44.3057H22.1161C15.1685 44.3057 11.6946 44.3057 9.53624 42.2412C7.37787 40.1766 7.37787 36.8539 7.37787 30.2084V20.139Z" stroke="#141B34" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M28.4325 32.2222H35.8016" stroke="#141B34" stroke-width="1.5" stroke-linecap="round"/>
        ...
        <div class="col-start-2 my-[2.36rem] mx-[3rem] col-span-4 bg-[#FFFFFF] py-[2.81rem] px-[2.84rem] border-black rounded-md mt-[2.38rem]">
            <div>
                <h1 class="text-[1.875rem] uppercase font-bold">CREATE TEAM</h1>
                ...
                <div class="grid gap-5">
                    ...
                    <form method="POST" action="{{url('save-cases')}}">
                        ...
                        <div class="grid grid-flow-row col-2 gap-10">
                            <div class="grid col-start-1">
                                <div class="w-1/2">
                                    ...
                                    <input type="text" class="form-control text-black border border-black rounded w-full py-4 px-3 placeholderfont text-lg leading-tight focus:outline-none focus:border-black" name='team_name' placeholder='Team Name'>
                                    @error('team_name')
                        ...
                        <div class="grid grid-flow-row col-2 gap-10 mt-5">
                            <div class="grid col-start-1">
                                <div class="w-1/6">
                                    ...
                                    <input type="date" class="form-control text-black border border-black rounded w-full py-4 px-3 placeholderfont text-lg leading-tight focus:outline-none focus:border-black" name='creation_date' placeholder='Creation Date' value="{{ date('Y-m-d') }}">
                                    @error('creation_date')
                        ...
                        <div class="grid grid-flow-row col-2 gap-10 mt-5">
                            <div class="grid col-start-1">
                                <div class="w-1/6">
                                    <label class="form-label block labelname font-bold mb-2"l">Status:</label>
                                    <select name="status" class="form-control text-black border border-black rounded w-full py-4 px-3 placeholderfont text-lg leading-tight focus:outline-none focus:border-black">
                        ...
                        <div class="flex flex-row justify-end gap-2.5 mt-10">
                            <button type="submit" class="buttonFormat bg-blue-500 hover:bg-blue-600 text-white font-bold py-4 px-5 rounded">ADD TEAM</button>
                            <a href="{{ url('team-list') }}" class="buttonFormat bg-red-500 hover-bg-red-600 text-white font-bold py-2 px-4 rounded">BACK TO TEAM LIST</a>
                        </div>
                    </form>
