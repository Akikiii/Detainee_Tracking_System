<x-app-layout>
    ...
    <div class="grid grid-cols-5 bg-[#D9D9D9] grid-row-4">
        ...
        <!-- Sidebar -->
        <!-- <div class="col-start-1 mt-[2.36rem] min-h-screen col-span-1 bg-[#FFFFFF] border-2 border-black p-[1.44rem] max-w-[600px] mx-auto"> -->
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                            ...
                            <a href="{{url('cases-list')}}">
                                <div class="p-4 rounded-md w-56 h-56" style="display: flex; flex-direction: column; align-items: center;">
                                    ...
                                    <p class="navigation-text text-xl text-gray-900">CASE VIEW</p>
                                </div>
                            </a>
                            ...
                            <a href="{{url('user-list')}}">
                                <div class="p-4 rounded-md w-56 h-56" style="display: flex; flex-direction: column; align-items: center;">
                                    ...
                                    <p class="navigation-text text-xl text-gray-900">USER LIST</p>
                                </div>
                            </a>
