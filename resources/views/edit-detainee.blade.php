                ...
                <div class="grid gap-5">
                    ...
                    @csrf
                        ...
                        <div class="flex flex-col mt-5">
                            ...
                            <textarea class="form-control text-black border border-black rounded w-full py-4 px-3 input[type=text] text-lg leading-tight focus:outline-none focus:border-black" name="home_address" placeholder="Home Address (Street Name, City, State/Province, Postal Code)"value="{{$detainee->home_address}}">{{$detainee->home_address}}</textarea>
                            @error('home_address')
                        ...
                        <div class="grid grid-flow-row col-2 gap-10 mt-5">
                            ...
                            <div class="grid col-start-1">
                                ...
                                <input type="date" class="form-control text-black border border-black rounded w-full py-4 px-3 placeholderfont text-lg leading-tight focus:outline-none focus:border-black" name="birthday" value="{{ $detaineeDetails->birthday }}">
                                @error('birthday')
                                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="grid col-start-3">
                                ...
                                <input type="date" class="form-control text-black border border-black rounded w-full py-4 px-3 placeholderfont text-lg leading-tight focus:outline-none focus:border-black" name="detention_begin" value="{{ $detaineeDetails->detention_begin }}">
                        ...
                        <div class="flex flex-col mt-5">
                            ...
                            <input type="text" class="form-control text-black border border-black rounded w-full py-4 px-3 placeholderfont text-lg leading-tight focus:outline-none focus:border-black" name="mother_name" placeholder="Enter Mother's Name (Last Name, First Name + Middle Name)" value="{{$detaineeDetails->mother_name}}">
                            @error('mother_name')
                            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                                {{$message}}
                            </div>
                        ...
                        <div class="flex flex-col mt-5">
                            ...
                            <input type="text" class="form-control text-black border border-black rounded w-full py-4 px-3 placeholderfont text-lg leading-tight focus:outline-none focus:border-black" name="father_name" placeholder="Enter Father's Name (Last Name, First Name + Middle Name)" value="{{$detaineeDetails->father_name}}">
                            @error('father_name')
                            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                                {{$message}}
                            </div>
                        ...
                        <div class="flex flex-col mt-5">
                            ...
                            <input type="text" class="form-control text-black border border-black rounded w-full py-4 px-3 placeholderfont text-lg leading-tight focus:outline-none focus:border-black" name="emergency_contact_name" placeholder="Enter Emergency Contact Name (Last Name, First Name + Middle Name)" value="{{$detaineeDetails->emergency_contact_name}}">
                        ...
                        <div class="flex flex-col mt-5">
                            ...
                            <input type="text" class="form-control text-black border border-black rounded w-full py-4 px-3 placeholderfont text-lg leading-tight focus:outline-none focus:border-black" name="emergency_contact_number" placeholder="Enter Emergency Contact Number" value="{{$detaineeDetails->emergency_contact_number}}">
                        ...
                        <div class="flex flex-col mt-5">
                            ...
                            <div class="flex">
                                <input type="text" class="form-control text-black border border-black rounded w-full py-4 px-3 placeholderfont text-lg leading-tight focus:outline-none focus:border-black" name="related_photos" placeholder="Input the reason for detention here" value="{{$detaineeDetails->related_photos}}">  <!-- violations toh -->
                        ...
                        <div class="flex flex-col mt-5">
                            ...
                            <div class="flex">
                                <input type="text" class="form-control text-black border border-black rounded w-full py-4 px-3 placeholderfont text-lg leading-tight focus:outline-none focus:border-black mr-2" name="crime_history" placeholder="Enter detainee’s history of crime here" value="{{$detaineeDetails->crime_history}}">
                                @error('crime_history')
                                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                                    {{$message}}
                                </div>
