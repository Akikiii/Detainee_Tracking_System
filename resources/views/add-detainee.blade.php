                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="grid grid-flow-row col-2 gap-10 mt-5">
                                ...
                                <div class="grid col-start-2">
                                    ...
                                    <input type="text" class="form-control text-black border border-black rounded rounded w-full py-4 px-3 placeholderfont leading-tight focus:outline-none focus:border-black" name="email_address" placeholder="Enter Birthdate" > <!-- value="{{old('email_address')}}" -->
                                    <!-- @error('email_address')
                                    <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                                        {{$message}}
                                    </div>
