    ...
    <div class="grid grid-cols-5 bg-[#f0f2f5] grid-row-4">
        ...
        <div class="col-start-1 mt-[2.36rem] h-screen col-span-1 bg-[#FFFFFF] border-black pt-[1.44rem] pb-[3.72rem] px-[1rem]">
            ...
            <div class="grid gap-4 text-[1.125rem] row-start-1">
                <button class="flex items-center gap-[0.5rem]">
                ...
                <div class="sections ml-1">
                    <button class="flex items-center gap-[0.5rem] mt-2">
                ...
                <div class="sections ml-1">
                    <button class="flex items-center gap-[0.5rem] mt-3">
                ...
                <div class="grid gap-5">
                    ...
                    <form method="POST" action="{{url('save-detainee')}}">
                        ...
                        <div class="flex flex-col">
                            <label class="form-label block labelname font-bold mb-2">Name</label>
                        ...
                        <div class="flex flex-col mt-5">
                            <label class="form-label block labelname font-bold mb-2">Home Address</label>
                            <textarea class="form-control text-black border border-black rounded w-full py-4 px-3 placeholderfont text-lg leading-tight focus:outline-none focus:border-black" name="home_address" placeholder="Home Address (Street Name, City, State/Province, Postal Code)" value="{{old('home_address')}}"></textarea>
                            @error('home_address')
                            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                                {{$message}}
                            </div>
                        ...
                        <div class="grid grid-flow-row col-2 gap-10 mt-5">
                            <div class="grid col-start-1">
                                <label class="form-label block labelname font-bold mb-2">Contact number</label>
                            ...
                            <div class="grid col-start-2">
                                <label class="form-label block labelname font-bold mb-2">Email Address</label>
                            ...
                            <div class="grid col-start-3">
                                <label class="form-label block labelname font-bold mb-2">Detainee ID</label>
                            ...
                            <div class="grid col-start-4">
                                <label class="form-label block labelname font-bold mb-2">Gender</label>
                            ...
                            <div class="grid col-start-5">
                                <label class="form-label block labelname font-bold mb-2">Start of Detention</label>
                            ...
                            <div class="grid col-start-6">
                                <label class="form-label block labelname font-bold mb-2">Max Detention Period</label>
                                <input type="text" class="form-control text-black border border-black rounded w-full py-4 px-3 placeholderfont text-lg leading-tight focus:outline-none focus:border-black" name="max_detention_period" placeholder="Max Detention" value="{{old('max_detention_period')}}">
                        ...
                        <div class="flex flex-col mt-5">
                            <label class="form-label block labelname font-bold mb-2">Mother Name</label>
                        ...
                        <div class="flex flex-col mt-5">
                            <label class="form-label block labelname font-bold mb-2">Father Name</label>
                        ...
                        <div class="flex flex-col mt-5">
                            <label class="form-label block labelname font-bold mb-2">Spouse Name</label>
                        ...
                        <div class="flex flex-col mt-5">
                            <label class="form-label block labelname font-bold mb-2">Emergency Contact Name</label>
                        ...
                        <div class="flex flex-col mt-5">
                            <label class="form-label block labelname font-bold mb-2">Emergency Contact Number</label>
                        ...
                        <!-- FIX TO ADD PHOTOS -->
                        <div class="flex flex-col mt-5">
                            <label class="form-label block labelname font-bold mb-2">Medical Information</label>
                            <div class="flex">
                                <input type="text" class="form-control text-black border border-black rounded w-full py-4 px-3 placeholderfont text-lg leading-tight focus:outline-none focus:border-black mr-2" name="medical_information" placeholder="Input Detainee’s existing allergy and conditions (Upload Medical Documents)" value="{{old('Medical Information')}}">
                        ...
                        <div class="flex flex-col mt-5">
                            <label class="form-label block labelname font-bold mb-2">Reason For Detention</label>
                            <div class="flex">
                                <input type="text" class="form-control text-black border border-black rounded w-full py-4 px-3 placeholderfont text-lg leading-tight focus:outline-none focus:border-black mr-2" name="related_photos" placeholder="Input the reason for detention here (Upload Documents if necessary)">
                        ...
                        <div class="flex flex-col mt-5">
                            <label class="form-label block labelname font-bold mb-2">Detainee’s Crime History</label>
                            <div class="grid grid-flow-col gap-10">
                                <input type="text" class="form-control text-black border border-black rounded w-full py-4 px-3 placeholderfont text-lg leading-tight focus:outline-none focus:border-black" name="crime_history" placeholder="Enter detainee’s history of crime here" value="{{old('crime_history')}}">
                                @error('crime_history')
                                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                                    {{$message}}
                                </div>
                        ...
                        <div class="flex flex-row justify-end gap-2.5 mt-[2.12rem]">
                            <button type="submit" class="buttonFormat bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded">ADD DETAINEE</button>
